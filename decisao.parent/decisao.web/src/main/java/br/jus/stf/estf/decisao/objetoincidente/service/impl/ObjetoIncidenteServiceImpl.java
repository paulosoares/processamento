...
//	}
	...
	private ListaJulgamento criarListaJulgamento (DadosAgendamentoDto dadosAgendamento) throws ServiceException {
		...
		if(sessao.getExclusivoDigital() == null) {
	...
	private void validarPermissaoAgendamentoVirtual(DadosAgendamentoDto dadosAgendamento) throws ServiceException {
		if (dadosAgendamento.getSessao() == null) // A sessão é nula quando é liberação para pauta
			return;
...
//		return false;
	...
	public void registrarLogSistema(ObjetoIncidente objetoIncidente, String dscTransacao, String dscFuncionalidade, Long chaveTabela, String nomeTabela) throws ServiceException{
		...
		try {
			objetoIncidenteService.registrarLogSistema(objetoIncidente, dscTransacao, dscFuncionalidade, chaveTabela, nomeTabela);
		} catch  (Exception e) {
	...
	public void registrarLogSistema(Long idObjetoIncidente, String dscTransacao, String dscFuncionalidade, Long chaveTabela, String nomeTabela) throws ServiceException{
		...
		try {
			objetoIncidenteService.registrarLogSistema(idObjetoIncidente, dscTransacao, dscFuncionalidade, chaveTabela, nomeTabela);
		} catch  (Exception e) {
			throw new ServiceException(e);
		}
	}
