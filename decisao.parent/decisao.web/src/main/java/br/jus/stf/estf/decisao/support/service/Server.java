...
public class Server implements IServer, ServletContextAware {
	...
	public Server(TextoService textoService, DocumentoTextoService documentoTextoService,
			...
			DadosMontagemRepercussaoGeralBuilder dadosMontagemRepercussaoGeralBuilder, PermissionChecker permissionChecker, MinistroService ministroService) {
		super();
	...
	public Long salvarNovoArquivo(Long seqObjetoIncidente, Long tipoTexto, String tipoVotoId, Long objetoIncidentePai,
			Long idTipoIncidenteJulgamento, String responsavelStr, String observacao, Long ministroDivergenteId, InputStream arquivoStream)
