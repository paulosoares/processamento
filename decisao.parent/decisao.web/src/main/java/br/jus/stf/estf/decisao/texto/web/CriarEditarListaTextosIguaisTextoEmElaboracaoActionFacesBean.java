...
@Action(id="criarEditarListaTextosIguaisTextoEmElaboracaoActionFacesBean", 
		name="Criar/Editar Lista de Textos Iguais", 
		view="/acoes/texto/listaTextosIguais.xhtml",
		height=360)
@Restrict({ActionIdentification.CRIAR_EDITAR_LISTA_DE_TEXTOS_IGUAIS, ActionIdentification.EDITAR_TEXTO_EM_ELABORACAO})
@States({ FaseTexto.EM_ELABORACAO})
@RequiresResources(Mode.One)
@CheckMinisterId
@CheckRestrictions
public class CriarEditarListaTextosIguaisTextoEmElaboracaoActionFacesBean extends
