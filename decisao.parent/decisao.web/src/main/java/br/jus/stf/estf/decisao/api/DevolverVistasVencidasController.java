...
public class DevolverVistasVencidasController extends HttpServlet {
	...
	private void devolverVistasVencidas(Principal principal) {
		try {
			Authentication authentication = new AnonymousAuthenticationToken("ACL_REPGERAL", getPrincipal(), new GrantedAuthority[]{new JaasGrantedAuthority("RS_DECISAO_GERENTE", null) });
	...
	protected Principal getPrincipal() {
		if (principal == null) {
			...
			setor.setId(Setor.CODIGO_SECAO_DE_SISTEMAS_DE_GABINETES_E_JULGAMENTOS);
