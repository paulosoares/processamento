...
public interface ObjetoIncidenteService {
	...
	AndamentoProcesso criarAndamentoParaProcessoLista(DadosAgendamentoDto dados, ObjetoIncidente<?> objetoIncidente, Integer codigoColegiado, Long codigoAndamento) throws ServiceException;
	...
	public void registrarLogSistema(Long idObjetoIncidente, String dscTransacao, String dscFuncionalidade, Long chaveTabela, String nomeTabela) throws DaoException, ServiceException;
