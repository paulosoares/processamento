...
public class ConfigurarOpcoesGabineteActionFacesBean extends ActionSupport<AllResourcesDto> {
	...
	private boolean proibirAgendamentoVirtual = false;
	private boolean proibirNovoTexto = false;
	...
	public void load() {
		try {
			...
			proibirAgendamentoVirtual = configuracaoSistemaService.isProibirAgendamentoVirtual();
			proibirNovoTexto = configuracaoSistemaService.isProibirNovoTexto();
	...
	public void execute() {
		try {
			...
			configuracaoSistemaService.setProibirAgendamentoVirtual(isProibirAgendamentoVirtual());
			configuracaoSistemaService.setProibirNovoTexto(isProibirNovoTexto());
		} catch (Exception e) {
