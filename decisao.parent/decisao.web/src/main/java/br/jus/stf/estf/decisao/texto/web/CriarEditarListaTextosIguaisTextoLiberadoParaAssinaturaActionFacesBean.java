...
@Action(id="criarEditarListaTextosIguaisTextoLiberadoParaAssinaturaActionFacesBean", 
		name="Criar/Editar Lista de Textos Iguais", 
		view="/acoes/texto/listaTextosIguais.xhtml",
		height=360)
@Restrict({ActionIdentification.CRIAR_EDITAR_LISTA_DE_TEXTOS_IGUAIS, ActionIdentification.EDITAR_TEXTO_LIBERADO_PARA_ASSINATURA})
@States({FaseTexto.LIBERADO_ASSINATURA})
@RequiresResources(Mode.One)
@CheckMinisterId
@CheckRestrictions
public class CriarEditarListaTextosIguaisTextoLiberadoParaAssinaturaActionFacesBean extends
