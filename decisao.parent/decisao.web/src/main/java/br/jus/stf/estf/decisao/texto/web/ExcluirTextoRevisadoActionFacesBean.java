 ...
 * @since 17.05.2011
 */
@Action(id="excluirTextoRevisadoActionFacesBean", 
		name="Excluir Textos", 
		view="/acoes/texto/excluirTexto.xhtml")
@Restrict({ActionIdentification.EXCLUIR_TEXTO, ActionIdentification.EDITAR_TEXTO_REVISADO})
@RequiresResources(Mode.Many)
@States({ FaseTexto.REVISADO})
@CheckMinisterId
@CheckTextoDigital
@CheckRestrictions
public class ExcluirTextoRevisadoActionFacesBean extends
