...
//		id.setSessionId(recuperarSessionId(request));
	...
	public String getConteudo() {
		try {
			try {
				objetoIncidenteService.registrarLogSistema(texto.getObjetoIncidente() , "CONSULTA_TEXTO", "Visualizar Texto "+texto.getTipoTexto().getDescricao(),texto.getId(),"STF.TEXTOS");
			} catch (ServiceException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public void editar(TextoDto texto) {
		...
		try {
			objetoIncidenteService.registrarLogSistema(texto.getIdObjetoIncidente(), "CONSULTA_TEXTO", "Editar Texto no STFOffice: "+texto.getId()+" - "+texto.getTipoTexto().getDescricao(),texto.getId(),"STF.TEXTOS");
		} catch (ServiceException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (DaoException e) {
