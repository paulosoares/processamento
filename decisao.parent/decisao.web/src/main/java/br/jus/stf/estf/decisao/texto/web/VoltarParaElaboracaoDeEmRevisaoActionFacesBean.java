 ...
 *
 */
@Action(id = "voltarParaElaboracaoDeEmRevisaoActionFacesBean", name = "Voltar para Elaboração", view = "/acoes/texto/transicao/executar.xhtml", height = 215, width = 500)
@Restrict({ActionIdentification.VOLTAR_PARA_ELABORACAO_DE_EM_REVISAO})
@States({ FaseTexto.EM_REVISAO})
@RequiresResources(Mode.Many)
@CheckMinisterId
@CheckRestrictions
public class VoltarParaElaboracaoDeEmRevisaoActionFacesBean extends AbstractAlterarFaseDoTextoActionFacesBean<TextoDto> {
