 ...
 * @since 13.05.2011
 */
public class RequisicaoTesteAssinaturaComunicacao extends
		RequisicaoJnlpAssinador<ComunicacaoWrapper> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8774487892051745006L;

	public RequisicaoTesteAssinaturaComunicacao() {
