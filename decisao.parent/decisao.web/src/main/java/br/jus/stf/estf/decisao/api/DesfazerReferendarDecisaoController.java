...
@Controller
public class DesfazerReferendarDecisaoController extends HttpServlet {
	...
	public DesfazerReferendarDecisaoController() {
		super();
	}

	private List<ReferendarDecisaoResultadoDto> desfazerReferendarDecisao(List<ReferendarDecisaoDto> lista, Principal principal) {
		try {
			referendarDecisaoService = (ReferendarDecisaoService) getService("referendarDecisaoService");
			List<ReferendarDecisaoResultadoDto> result = referendarDecisaoService.desfazerReferendarDecisao(lista, principal);
			return result;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ReferendarDecisaoResultadoDto> resultado = desfazerReferendarDecisao(lista, getPrincipal());
