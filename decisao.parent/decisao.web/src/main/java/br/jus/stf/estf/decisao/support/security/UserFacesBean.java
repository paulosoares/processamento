	...
	public Principal getPrincipal() {
		...
		if (!isConfiguracaoTextoRestritoLoaded) {
			try {
				...
				if(principal.getMinistro() == null && !principal.getSetores().isEmpty()) {
					getPrincipal().setMinistro(ministroService.recuperarMinistro(setorService.recuperarPorId(principal.getSetores().iterator().next().getId())));
				}
