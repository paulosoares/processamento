...
public enum TextoRelatorioEnum{
	...
	NUMERO_PROCESSO("processo.numeroProcesso", "Número Processual", 60, false),
	RECURSO("processo.tipoRecurso", "Recurso", 100, false),
	MINISTRO("processo.ministro", "Ministro", 130, false),
	TIPO_TEXTO("tipoTexto", "Tipo Texto", 80, false),
	PUBLICO("publico", "Público", 30, false),
	...
	DATA_SESSAO("dataSessao", "Data da Sessão", 50, false),
	OBSERVACAO("observacao", "Observação", 100, false),
	TIPO_RESTRICAO("tipoRestricao", "Restrição", 60, false),
	TIPO_FASE_TEXTO_DOCUMENTO("tipoFaseTextoDocumento", "Fase Texto", 60, false),
	USUARIO_INCLUSAO("usuarioInclusao", "Usuário Inclusão", 60, false),
	USUARIO_ALTERACAO("usuarioAlteracao", "Usuário Alteração", 60, false),
	DATA_INCLUSAO("dataInclusao", "Data Inclusão", 60, false),
	DATA_ALTERACAO("dataAlteracao", "Data Alteração", 60, false);
