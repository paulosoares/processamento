...
@CheckMinisterId
@CheckRestrictions
@CheckIdTipoTexto({TipoTexto.CODIGO_ACORDAO, TipoTexto.CODIGO_EMENTA, TipoTexto.CODIGO_RELATORIO, TipoTexto.CODIGO_VOTO, TipoTexto.CODIGO_ANTECIPACAO_AO_VOTO})
