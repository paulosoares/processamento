...
public class TextoDto implements Dto, Documento {
	...
	public static TextoDto valueOf(Texto texto, boolean carregarIdArquivoEletronico) {
		...
		dto.setJulgamentoDigital(Boolean.TRUE.equals(texto.getJulgamentoDigital()));
	...
	public boolean isJulgamentoDigital() {
		return julgamentoDigital;
	}

	public void setJulgamentoDigital(boolean julgamentoDigital) {
		this.julgamentoDigital = julgamentoDigital;
	}
	
	public boolean getJulgamentoDigital() {
		return this.julgamentoDigital;
	}
}
