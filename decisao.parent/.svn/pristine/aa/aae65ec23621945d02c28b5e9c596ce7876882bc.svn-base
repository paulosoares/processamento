...
@Ignore
public class AssinaturaPdfSHA256withRSADemoTest extends AbstractAssinaturaDemoTest {

	@Test
	public void testGerarPdfAssinadoSHA256ComCadeia() throws Exception {
		...
		byte[] assinaturaExterna = hookAssinarExternamenteSHA256(sh);
		...
		FileOutputStream fos = new FileOutputStream(AssinaturaTestUtil.getPathTempDirFile(NOME_PDF_DE_TESTE_001 + "-assinado-sha256.pdf"));
		os.writeTo(fos);
		fos.flush();
		fos.close();
	}
