...
public class SHA1WincerSignedAssinadorPorPartesTest extends AbstractAssinaturaDemoTest {
	...
	public void testGerarPdfAssinado() throws Exception {
		app = new SHA1WincerSignedAssinadorPorPartes();
	...
	private void validarPdf(byte[] pdfAssinado) throws IOException, NoSuchAlgorithmException, SignatureException {
