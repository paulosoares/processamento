 ...
 */
public abstract class PagedListDataModel<T extends Dto> extends DataModel<T> {
    ...
    public Object getRowData(){
        ...
        return page.getResults().get(rowIndex - startRow);
    }
    ...
    public boolean isRowAvailable() {
        ...
        if (rowIndex < 0) {
            return false;
        } else if (rowIndex >= page.getTotal()) {
            return false;
        } else {
            return true;
        }
    ...
    /**
     * @see br.jus.stf.estf.decisao.support.controller.faces.datamodel.DataModel#reset()
     */
    public void reset() {
        this.rowIndex = -1;
        this.page = null;
   ...
   /**
     ...
     */
    public abstract PagedList<T> fetchPage(int startRow, int pageSize);
