 ...
 * @since 17.10.2011
 */
@Action(id = "gerenciarListasLiberadasActionFacesBean", name = "Listas Liberadas", view = "/acoes/objetoincidente/gerenciarListasLiberadas.xhtml", width = 900)
...
public class GerenciarListasLiberadasActionFacesBean extends ActionSupport<ListaJulgamento> {
	...
	public boolean getApresentarCabecalhoDoVistor(){
		return getListaJulgamento().getTipoListaJulgamento().getId().equals(TipoListaJulgamento.LISTAS_DE_DEVOLUCOES_DE_VISTAS_DE_PROCESSOS_EM_LISTA.getId()) && getMinistro().equals(getListaJulgamento().getMinistroVistor());   
	}
