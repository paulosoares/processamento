...
@Action(id="criarEditarListaTextosIguaisTextoEmRevisaoActionFacesBean", 
		name="Criar/Editar Lista de Textos Iguais", 
		view="/acoes/texto/listaTextosIguais.xhtml",
		height=360)
@Restrict({ActionIdentification.CRIAR_EDITAR_LISTA_DE_TEXTOS_IGUAIS, ActionIdentification.EDITAR_TEXTO_EM_REVISAO})
@States({ FaseTexto.EM_REVISAO})
@RequiresResources(Mode.One)
@CheckMinisterId
@CheckRestrictions
public class CriarEditarListaTextosIguaisTextoEmRevisaoActionFacesBean extends
