...
public class OGestorPodeFinalizarARevisãoDoDocumento {
	...
	public OGestorPodeFinalizarARevisãoDoDocumento(WebDriver browser) {
		this.browser = browser;
		System.out.println();
		System.out.println("#### Finalizar Revisão ####");
