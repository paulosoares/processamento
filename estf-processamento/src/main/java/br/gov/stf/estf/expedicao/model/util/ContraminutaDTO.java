...
public class ContraminutaDTO {
	...
	public static class Builder{
		...
		public ContraminutaDTO builder(){
			return new ContraminutaDTO(processo,corpo,nomeFuncaoSecretaria,nomeSecao, partes);
		}
