...
public class PecaDTO {
    ...
    private String isUtilizadaEmVista;
	...
	public String getIsUtilizadaEmVista() {
		return isUtilizadaEmVista;
	}

	public void setIsUtilizadaEmVista(String isUtilizadaEmVista) {
		this.isUtilizadaEmVista = isUtilizadaEmVista;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof PecaDTO) {
			if (this.id.equals(((PecaDTO) obj).getId())) {
				return true;
			}			
		}
		return false;
