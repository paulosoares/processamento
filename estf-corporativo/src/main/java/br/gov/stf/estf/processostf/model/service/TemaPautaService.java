 ...
 * @since 08.08.2011
 */
public interface TemaPautaService extends GenericService<TemaPauta, Long, TemaPautaDao> {
	
	List<TemaPauta> pesquisarTemaPauta(PautaPlenario pautaPlenario) throws ServiceException;
