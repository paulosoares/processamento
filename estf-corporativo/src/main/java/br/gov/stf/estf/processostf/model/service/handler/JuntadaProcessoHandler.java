...
public class JuntadaProcessoHandler extends AndamentoProcessoHandler {
	...
	public void posRegistroAndamento(AndamentoProcesso andamentoProcesso, Processo processoAndamento, List<Processo> processosPrincipais, Peticao peticao, Setor setor, String codigoUsuario, Origem origem, Comunicacao comunicacao) throws ServiceException {
		...
		throw new ServiceException("Não é permitido o registro de andamento do tipo 8245 - Juntada ao Processo por este sistema.");
		//processoDependenciaService.criarDependencia(andamentoProcesso, processoPrincipal, ProcessoDependencia.TipoProcessoDependenciaEnum.JUNTADA.getCodigo());
	}
}