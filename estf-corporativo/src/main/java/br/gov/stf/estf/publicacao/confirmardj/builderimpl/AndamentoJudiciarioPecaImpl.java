...
public class AndamentoJudiciarioPecaImpl extends ConfirmarMateriaBuilder<ProcessoPublicado> {
	private Date dataAtual = new Date();
	public AndamentoJudiciarioPecaImpl(ConteudoPublicacao conteudoPublicacao) {
	...
	public void confirmar(Publicacao publicacao, String siglaUsuario,
		...
		inserirTextoAndamento(entidade, andamentoProcesso);
		
	}

	@Override
	public Long getCodigoAndamento(ProcessoPublicado entidade) {
		int codigoMateria = entidade.getCodigoMateria();
		if ( codigoMateria==5 ) {
			return 7910L;
		} else {
			return 7909L;
