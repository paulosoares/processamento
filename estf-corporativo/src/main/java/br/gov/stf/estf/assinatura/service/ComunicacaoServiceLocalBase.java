...
/**
 * Serviço local utilizado para realizar diversas operações sobre comunicações e
 * documentos.
 *
 * @author thiago.miranda
 * @since 3.16.1
 */
public interface ComunicacaoServiceLocalBase {

    void encaminharParaAssinaturaSetor(List<? extends ComunicacaoDocumentoBase> comunicacaoDocumentos,
            Long idSetorDestino,
            boolean permitirGabinete,
            boolean incluirFaseNoDeslocamento,
            boolean naoIncluirFaseDeslocamentoSeNaoForGabinete,
            TipoFaseComunicacao... tiposFasesPermitidos) throws ServiceLocalException, RegraDeNegocioException;

    void encaminharParaRevisaoSetor(List<ComunicacaoDocumentoBase> comunicacaoDocumentos,
            Long idSetorDestino,
            boolean permitirGabinete,
            boolean incluirFaseNoDeslocamento,
            boolean naoIncluirFaseDeslocamentoSeNaoForGabinete,
    ...
    Long pesquisarSetorDestinoPadrao(List<? extends ComunicacaoDocumentoBase> comunicacaoDocumentos) throws ServiceLocalException, RegraDeNegocioException;

    void excluir(List<? extends ComunicacaoDocumentoBase> comunicacaoDocumentos) throws ServiceLocalException, RegraDeNegocioException;
    ...
    List pesquisarComunicacoes(String siglaProcesso,
            Long numeroProcesso,
            Long codigoFaseDocumento,
            Long codigoSetorAtual,
            Long numeracaoUnica,
            Long anoNumeracaoUnica,
            String dataInicial,
            String dataFinal)
            throws ServiceLocalException, RegraDeNegocioException;
    ...
    void cancelarAssinatura(ComunicacaoDocumentoBase comunicacaoDocumento, String anotacaoCancelamento, UsuarioAssinatura usuario) throws ServiceLocalException, RegraDeNegocioException;

    void cancelarPDF(DocumentoComunicacao docComunicacao, String observacao, UsuarioAssinatura usuario, boolean gerarFaseCorrecao) throws ServiceLocalException, RegraDeNegocioException;

    void cancelarPDF(DocumentoComunicacao docComunicacao, String descricaoStatusDocumento, String observacao, UsuarioAssinatura usuario, boolean gerarFaseCorrecao) throws ServiceLocalException, RegraDeNegocioException;

    void devolverParaSetorOrigem(ComunicacaoDocumentoBase comunicacaoDocumento, String anotacaoCancelamento, UsuarioAssinatura usuario) throws ServiceLocalException, RegraDeNegocioException;

    void expedir(List<? extends ComunicacaoDocumentoBase> comunicacaoDocumentos, UsuarioAssinatura usuario) throws ServiceLocalException, RegraDeNegocioException;    
    
    void encaminharParaDJe(List<ComunicacaoDocumentoBase> comunicacaoDocumentos, UsuarioAssinatura usuario) throws ServiceLocalException, RegraDeNegocioException;

    void finalizar(List<? extends ComunicacaoDocumentoBase> comunicacaoDocumentos, UsuarioAssinatura usuario) throws ServiceLocalException, RegraDeNegocioException;

    void finalizarRevisao(List<? extends ComunicacaoDocumentoBase> comunicacaoDocumentos, UsuarioAssinatura usuario) throws ServiceLocalException;

    List<ComunicacaoDocumentoResult> pesquisarDocumentos(Long seqObjetoIncidente,
            Long codigoModelo,
            Setor setor,
            UsuarioAssinatura usuario) throws ServiceLocalException, RegraDeNegocioException;
	...
	Comunicacao criarComunicacaoIntimacao(Date dataEnvioComunicacao, Setor setor, String usuarioCriador,
			Long codigoPessoaDestinatario, ModeloComunicacao modeloComunicacao, Collection<Long> idsObjetoIncidente,
			TipoFaseComunicacao tipoFaseComunicacao, List<?> pecas, List<AndamentoProcesso> andamentos,
			Long numeroDocumento, String descricaoComunicacao, byte[] arquivoEletronico,
			DocumentoEletronico documentoAcordao) throws ServiceException;    
