...
public class RelacaoSessaoEspecialADPF extends ConteudoBuilder<ESTFBaseEntity> {
	...
	public List<Conteudo> gerarConteudo(ConteudoPublicacao cp, Integer indiceInicial, boolean ordernarProcessos, boolean pesquisarTextos)
		...
		try {
			...
			List acordaos = getRelacaoAcordaosSessaoEspecialADPF(ordernarProcessos);
			List processos = getRelacaoProcessosSessaoEspecialADPF(ordernarProcessos);
