...
public class RelacaoPeticaoImpl extends ConteudoBuilder<TextoPeticao>{
	...
	public List<Conteudo> gerarConteudo(ConteudoPublicacao cp, Integer indiceInicial, boolean ordernarProcessos, boolean pesquisarTextos)
		...
		ConteudoRelacao<TextoPeticao> conteudoRelacao = new ConteudoRelacao<TextoPeticao>();
		conteudoRelacao.setRelacao( empacotarItensRelacao(getRelacaoTextoPeticao(ordernarProcessos ,cp),indiceInicial, pesquisarTextos) );
