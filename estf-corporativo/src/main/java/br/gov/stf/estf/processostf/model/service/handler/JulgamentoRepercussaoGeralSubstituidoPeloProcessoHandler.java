...
public class JulgamentoRepercussaoGeralSubstituidoPeloProcessoHandler extends AndamentoProcessoHandler {
	...
	public String getSituacao(AndamentoProcesso andamentoProcesso) throws ServiceException {
		...
		exemplo.setTipoDependenciaProcesso(TipoProcessoDependenciaEnum.JULGAMENTO_REPERCUSSAO_GERAL_SUBSTITUIDO_PELO_PROCESSO_NO.getCodigo());
	...
	public void posRegistroAndamento(AndamentoProcesso andamentoProcesso, Processo processoAndamento, List<Processo> processosPrincipais, Peticao peticao, Setor setor, String codigoUsuario, Origem origem, Comunicacao comunicacao) throws ServiceException {
		...
		throw new ServiceException("Este andamento é exclusivo do eSTF-Repercussão Geral (plenário virtual).");
		//processoDependenciaService.criarDependencia(andamentoProcesso, processoPrincipal, ProcessoDependencia.TipoProcessoDependenciaEnum.JULGAMENTO_REPERCUSSAO_GERAL_SUBSTITUIDO_PELO_PROCESSO_NO.getCodigo());
	}
}