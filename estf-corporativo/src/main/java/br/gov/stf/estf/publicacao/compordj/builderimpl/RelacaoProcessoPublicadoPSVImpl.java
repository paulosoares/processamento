...
public class RelacaoProcessoPublicadoPSVImpl extends ConteudoBuilder<ProcessoPublicado>{
	...
	protected List pesquisarTextos(ProcessoPublicado entidade)
			throws ServiceException {
		List<Texto> decisoes = getRelacaoTextoEditalProcessoPublicado(entidade, conteudoPublicacao.getDataCriacao());
		return decisoes;
	}
