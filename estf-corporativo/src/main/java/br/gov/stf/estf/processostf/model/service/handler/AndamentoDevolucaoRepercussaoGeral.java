...
public class AndamentoDevolucaoRepercussaoGeral extends AndamentoProcessoHandler {
	...
	public String getSituacao(AndamentoProcesso andamentoProcesso) throws ServiceException {
		...
		exemplo.setTipoDependenciaProcesso(TipoProcessoDependenciaEnum.DETERMINADA_A_DEVOLUCAO_PELA_REPERCUSSAO_GERAL.getCodigo());
...
//			processoDependenciaService.criarDependencia(andamentoProcesso, processosPrincipais.get(processosPrincipais.size()-1), ProcessoDependencia.TipoProcessoDependenciaEnum.DETERMINADA_A_DEVOLUCAO_PELA_REPERCUSSAO_GERAL.getCodigo());
	}
}