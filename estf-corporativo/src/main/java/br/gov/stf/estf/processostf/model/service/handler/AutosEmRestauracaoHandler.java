...
public class AutosEmRestauracaoHandler extends AndamentoProcessoHandler {
	...
	public String getSituacao(AndamentoProcesso andamentoProcesso) throws ServiceException {
		...
		exemplo.setTipoDependenciaProcesso(TipoProcessoDependenciaEnum.AUTOS_EM_RESTAURACAO.getCodigo());
	...
	public void posRegistroAndamento(AndamentoProcesso andamentoProcesso, Processo processoAndamento, List<Processo> processosPrincipais, Peticao peticao, Setor setor, String codigoUsuario, Origem origem, Comunicacao comunicacao) throws ServiceException {
		...
		processoDependenciaService.criarDependencia(andamentoProcesso, processosPrincipais.get(0), ProcessoDependencia.TipoProcessoDependenciaEnum.AUTOS_EM_RESTAURACAO.getCodigo());
	}
}