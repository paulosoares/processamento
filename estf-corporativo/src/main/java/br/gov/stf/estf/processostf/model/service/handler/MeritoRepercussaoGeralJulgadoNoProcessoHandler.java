...
public class MeritoRepercussaoGeralJulgadoNoProcessoHandler extends AndamentoProcessoHandler {
	...
	public String getSituacao(AndamentoProcesso andamentoProcesso) throws ServiceException {
		...
		exemplo.setTipoDependenciaProcesso(TipoProcessoDependenciaEnum.MERITO_DA_REPERCUSSAO_GERAL_JULGADO_NO_PROCESSO_NO.getCodigo());
	...
	public void posRegistroAndamento(AndamentoProcesso andamentoProcesso, Processo processoAndamento, List<Processo> processosPrincipais, Peticao peticao, Setor setor, String codigoUsuario, Origem origem, Comunicacao comunicacao) throws ServiceException {
		...
		//processoDependenciaService.criarDependencia(andamentoProcesso, processoPrincipal, ProcessoDependencia.TipoProcessoDependenciaEnum.MERITO_DA_REPERCUSSAO_GERAL_JULGADO_NO_PROCESSO_NO.getCodigo());
	}
}