...
@Repository
public class TextoProtocoloDaoHibernate extends GenericHibernateDao<TextoPeticao, Long> 
	implements TextoProtocoloDao {

	public TextoProtocoloDaoHibernate() {
...
//			c.add( Restrictions.eq("objetoIncidente.tipoObjetoIncidente", TipoObjetoIncidente.PROTOCOLO.getCodigo()) );
//			
//			resp = c.list();
			...
			q.setString("tipoObjetoIncidente", TipoObjetoIncidente.PROTOCOLO.getCodigo());
