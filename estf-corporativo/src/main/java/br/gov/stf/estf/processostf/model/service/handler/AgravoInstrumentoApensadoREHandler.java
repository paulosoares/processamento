...
public class AgravoInstrumentoApensadoREHandler extends AndamentoProcessoHandler {
	...
	public String getSituacao(AndamentoProcesso andamentoProcesso) throws ServiceException {
		...
		exemplo.setTipoDependenciaProcesso(TipoProcessoDependenciaEnum.AGRAVO_DE_INSTRUMENTO_APENSADO_AO_RE_NO.getCodigo());
	...
	public void preRegistroAndamento(AndamentoProcesso andamentoProcesso, Processo processoAndamento, List<Processo> processosPrincipais, Peticao peticao, Setor setor, String codigoUsuario, Origem origem) throws ServiceException {
		andamentoProcessoService.verificarPossibilidadeApensamento(processoAndamento, processosPrincipais.get(0));
		if (!processosPrincipais.get(0).getSiglaClasseProcessual().equals("RE")) {
			throw new AIApensadoNaoREException("Para o andamento 8241 é necessário selecionar um RE.");
		}
	}
	...
	public void posRegistroAndamento(AndamentoProcesso andamentoProcesso, Processo processoAndamento, List<Processo> processosPrincipais, Peticao peticao, Setor setor, String codigoUsuario, Origem origem, Comunicacao comunicacao) throws ServiceException {
		...
		processoDependenciaService.criarDependencia(andamentoProcesso, processosPrincipais.get(0), ProcessoDependencia.TipoProcessoDependenciaEnum.AGRAVO_DE_INSTRUMENTO_APENSADO_AO_RE_NO.getCodigo());
	}
}