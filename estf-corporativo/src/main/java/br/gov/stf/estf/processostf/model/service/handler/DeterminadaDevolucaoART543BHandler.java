...
public class DeterminadaDevolucaoART543BHandler extends AndamentoProcessoHandler {
	...
	public String getSituacao(AndamentoProcesso andamentoProcesso) throws ServiceException {
		...
		exemplo.setTipoDependenciaProcesso(TipoProcessoDependenciaEnum.DETERMINADA_A_DEVOLUCAO_ART543B.getCodigo());
	...
	public void posRegistroAndamento(AndamentoProcesso andamentoProcesso, Processo processoAndamento, List<Processo> processosPrincipais, Peticao peticao, Setor setor, String codigoUsuario, Origem origem, Comunicacao comunicacao) throws ServiceException {
		...
		processoDependenciaService.criarDependencia(andamentoProcesso, processosPrincipais.get(processosPrincipais.size()-1), ProcessoDependencia.TipoProcessoDependenciaEnum.DETERMINADA_A_DEVOLUCAO_ART543B.getCodigo());
	}
}