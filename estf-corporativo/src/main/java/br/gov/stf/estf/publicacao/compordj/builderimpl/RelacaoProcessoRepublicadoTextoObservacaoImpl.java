...
public class RelacaoProcessoRepublicadoTextoObservacaoImpl extends ConteudoBuilder<ProcessoPublicado> {
	...
	protected List pesquisarTextos(ProcessoPublicado entidade)
		...
		lista.add( entidade.getArquivoEletronicoTexto().getId() );
