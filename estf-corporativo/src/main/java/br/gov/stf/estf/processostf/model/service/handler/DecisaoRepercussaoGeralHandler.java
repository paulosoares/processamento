...
public class DecisaoRepercussaoGeralHandler extends AndamentoProcessoHandler {
	...
	public List<OrigemAndamentoDecisao> getOrigensDecisao(Andamento andamento) throws ServiceException {
		...
		idsOrigensDecisao.add(OrigemAndamentoDecisao.ConstanteOrigemDecisao.PLENARIO_VIRTUAL.getCodigo());
